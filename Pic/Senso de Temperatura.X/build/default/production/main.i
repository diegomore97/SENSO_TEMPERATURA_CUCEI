...
# 654 "/opt/microchip/xc8/v2.10/pic/include/pic18_chip_select.h" 3
...
# 655 "/opt/microchip/xc8/v2.10/pic/include/pic18_chip_select.h" 2 3
...
int8_t Comando(int8_t NumeroComando, int32_t Direccion, int8_t CRC)
{
    SPI_Write(0xFF);
    SPI_Write(NumeroComando);
...
void main(void) {
    ...
    char buffer [20];
    char bufferFecha [20];
    unsigned char horaCompleta[9] = "00:00:00";
    char fecha[9] = "00/00/00";
    ...
    while (1) {
        ...
        if (variableMostrar) {
            Lcd_Clear();
            Lcd_Set_Cursor(1, 1);
            sprintf(buffer, "LATI= %.4f", latitudMostrar);
            Lcd_Write_String(buffer);
            Lcd_Set_Cursor(2, 1);
            sprintf(buffer, "LONG= %.4f", (longitudMostrar*-1));
            Lcd_Write_String(buffer);
            ...
            Lcd_Clear();
            Lcd_Set_Cursor(1, 1);
            sprintf(buffer, "HORA= %s", horaCompleta);
            Lcd_Write_String(buffer);
            Lcd_Set_Cursor(2, 1);
            sprintf(buffer, "TEMP= %.2f", temperatura);
            Lcd_Write_String(buffer);
